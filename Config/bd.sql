...
SET AUTOCOMMIT = 0;
INSERT INTO InstalationCat (idTypeInstalation, name, capacity, mAncho, mLargo, mAlto) VALUES
(1, 'Oficina', 	 0, 100, 100, 100),
(2, 'Articulos', 1000, 100, 100, 100),
(3, 'Gestacion', 200, 100, 100, 100),
(3, 'Parto',     200, 100, 100, 100),
(3, 'Lechones',  200, 100, 100, 100),
(3, 'Marrano',   200, 100, 100, 100),
(3, 'Primales',  200, 100, 100, 100),
(3, 'Gordo',     200, 100, 100, 100);
COMMIT;
...
('Vivo','Macho',  94,  1 , 'Lactancia', 'Lechon',  'Sano', 5, '2018-10-02', '2018-12-09'),
('Vivo','Hembra', 90,  1,  'Lactancia', 'Lechon',  'Sano', 5, '2018-12-01', '2018-12-01'),
('Vivo','Macho',  100, 3,  'Levante',   'Marrano', 'Sano', 5, '2018-12-01', '2018-12-01'),
('Vivo','Hembra', 100, 3,  'Engorde',   'Marrano', 'Sano', 5, '2018-12-01', '2018-12-01'),
('Vivo','Hembra', 90,  1,  'Lactancia', 'Lechon',  'Sano', 5, '2018-12-01', '2018-12-01'),
('Vivo','Hembra', 90,  1,  'Lactancia', 'Lechon',  'Sano', 5, '2018-12-01', '2018-12-01');
COMMIT;
...
SET AUTOCOMMIT = 0;
INSERT INTO Person (NO_EMPLOYEE, state, salary, contract, hoursWorked,DOCUMENT, firstName, secondName, fatherLastName, motherLastName, sex, email, phone, celPhone, idRole, password, idInstalation) VALUES
(01,'En funciones','900000','Indefinido',100,'1090502664', 'Juan',  'Fernando', 'Romero',   'Ortega', 'Hombre', 'juanfernandoro@ufps.edu.co', '5782723', '3003719983', 01,  MD5('0001'), 1),
(02,'En funciones','900000','Servicio',70,'1090512864', 'Yindy', 'Paola',    'Pajaro',   'Urquijo', 'Mujer', 'yindypaolapu@ufps.edu.co',   '5486985', '3012546589', 10, MD5('1002'), 2),
(03,'Inhabilitado','900000','Servicio',0,'1085545454', 'Diego', 'Alirio',   'Gonzalez', 'Melgarejo', 'Hombre', 'diegoaliriogm@ufps.edu.co',  '5465623', '3012521456', 11, MD5('1103'), 3);
COMMIT;
...
SET AUTOCOMMIT = 0;
INSERT INTO Female (ID_FEMALE, state, virgin, gestation) VALUES 
(2, 'Asignada','Si', 'No'),
(4, 'Asignada', 'Si','No'),
(5, 'Asignada', 'No','No');
COMMIT;
...
SET AUTOCOMMIT = 0;
INSERT INTO Male (ID_MALE, state, physicalConformation) VALUES
(1, 'Asignado','Grosor de 24 cm los perniles'),
(3, 'Asignado','Aumento rapido de peso');
COMMIT;